...
public enum TokenType {
    ...
    TRUE, FALSE, IF, THEN, BEHAVIOR, FN, REQUIRES, CONSTRUCTS, MATCH, CASE, INCLUDE,
    // literals and identifiers
    IDENT, INT_LIT, DECIMAL_LIT, STRING_LIT,
    // punctuation
    LBRACE, RBRACE, LPAREN, RPAREN, LBRACKET, RBRACKET, COLON, COMMA, DOT, DOTDOT, ASSIGN, PIPE,
    ARROW, LARROW, FATARROW, PIPEFWD, QUESTION, PLUSPLUS,
    // operators
